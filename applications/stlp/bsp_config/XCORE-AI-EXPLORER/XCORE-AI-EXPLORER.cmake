...
add_library(xcore_sdk_app_stlp_board_support_xcore_ai_explorer INTERFACE)
target_sources(xcore_sdk_app_stlp_board_support_xcore_ai_explorer
    INTERFACE
...
target_include_directories(xcore_sdk_app_stlp_board_support_xcore_ai_explorer
    INTERFACE
        ${CMAKE_CURRENT_LIST_DIR}
)
target_link_libraries(xcore_sdk_app_stlp_board_support_xcore_ai_explorer
    INTERFACE
        sdk::core
        sdk::rtos_freertos
        sdk::rtos::audio_drivers
        sdk::app::stlp::dac::aic3204
)
target_compile_options(xcore_sdk_app_stlp_board_support_xcore_ai_explorer
    INTERFACE
        ${CMAKE_CURRENT_LIST_DIR}/XCORE-AI-EXPLORER.xn
)
target_link_options(xcore_sdk_app_stlp_board_support_xcore_ai_explorer
    INTERFACE
        ${CMAKE_CURRENT_LIST_DIR}/XCORE-AI-EXPLORER.xn
)
target_compile_definitions(xcore_sdk_app_stlp_board_support_xcore_ai_explorer
    INTERFACE
        XCOREAI_EXPLORER=1
...
## Create an alias
add_library(sdk::app::stlp::xcore_ai_explorer ALIAS xcore_sdk_app_stlp_board_support_xcore_ai_explorer)
