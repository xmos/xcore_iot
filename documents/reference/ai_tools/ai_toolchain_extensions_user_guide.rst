...
.. code-block:: console
    ...
    $ python $XMOS_AIOT_SDK_PATH/tools/generate/generate_model_runner.py <model_xcore.tflite> --name <runner_name>
...
.. code-block:: c
    ...
    // do something withthe output_buffer
    // ...
...
.. code-block:: console
    ...
    $ python $XMOS_AIOT_SDK_PATH/tools/generate/convert_tflite_to_c_source.py --input <model_xcore.tflite> --header <model_data.h> --source <model_data.c> --variable-name <model> --include-guard <MODEL_H_>

You will need to replace the details inside the brackets with values you prefer to use in your application firmware.  See the README files of the example firmware applications for instructions on how those models are converted to source code.
