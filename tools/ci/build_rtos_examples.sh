...
then
    ...
    applications=(
        ...
        "example_freertos_getting_started  XCORE-AI-EXPLORER  tools/xmos_cmake_toolchain/xs3a.cmake"
        "example_freertos_iot              XCORE-AI-EXPLORER  tools/xmos_cmake_toolchain/xs3a.cmake"
        "example_freertos_l2_cache         XCORE-AI-EXPLORER  tools/xmos_cmake_toolchain/xs3a.cmake"
    )
elif [ "$1" == "smoke" ]
then
    applications=(
