...
demos=(
    ...
    "demo_usbtmc             example_freertos_usb_tusb_demo_usbtmc                  XCORE-AI-EXPLORER  tools/xmos_cmake_toolchain/xs3a.cmake"
...
for ((i = 0; i < ${#demos[@]}; i += 1)); do
    ...
    (cd ${path}/build_${board}; cp examples/freertos/usb/${make_target}.xe ${DIST_DIR})
done
