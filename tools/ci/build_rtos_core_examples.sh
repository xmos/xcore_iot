...
applications=(
    ...
    "example_freertos_xlink_0         No  No  XCORE-AI-EXPLORER  xmos_cmake_toolchain/xs3a.cmake"
    "example_freertos_xlink_1         No  No  XCORE-AI-EXPLORER  xmos_cmake_toolchain/xs3a.cmake"
    "example_freertos_xscope_fileio    No  No  XCORE-AI-EXPLORER  xmos_cmake_toolchain/xs3a.cmake"
)
