...
/**
 * This attribute must be specified on all RTOS GPIO interrupt callback
...
/**
 * Function pointer type for application provided RTOS GPIO interrupt callback
 * functions.
 *
 ...
 *                      \note this is the latched value that triggered the
 * interrupt, not the current value.
 */
typedef void (*rtos_gpio_isr_cb_t)(rtos_gpio_t *ctx, void *app_data,
...
struct rtos_gpio_struct {
  ...
  __attribute__((fptrgroup("rtos_gpio_port_enable_fptr_grp"))) void (
      *port_enable)(rtos_gpio_t *, rtos_gpio_port_id_t);

  __attribute__((fptrgroup("rtos_gpio_port_in_fptr_grp")))
  uint32_t (*port_in)(rtos_gpio_t *, rtos_gpio_port_id_t);

  __attribute__((fptrgroup("rtos_gpio_port_out_fptr_grp"))) void (*port_out)(
      rtos_gpio_t *, rtos_gpio_port_id_t, uint32_t);

  __attribute__((fptrgroup("rtos_gpio_isr_callback_set_fptr_grp"))) void (
      *isr_callback_set)(rtos_gpio_t *, rtos_gpio_port_id_t, rtos_gpio_isr_cb_t,
                         void *);

  __attribute__((fptrgroup("rtos_gpio_interrupt_enable_fptr_grp"))) void (
      *interrupt_enable)(rtos_gpio_t *, rtos_gpio_port_id_t);

  __attribute__((fptrgroup("rtos_gpio_interrupt_disable_fptr_grp"))) void (
      *interrupt_disable)(rtos_gpio_t *, rtos_gpio_port_id_t);
 ...
 */
inline void rtos_gpio_port_enable(rtos_gpio_t *ctx,
                                  rtos_gpio_port_id_t port_id) {
 ...
 */
inline uint32_t rtos_gpio_port_in(rtos_gpio_t *ctx,
                                  rtos_gpio_port_id_t port_id) {
 ...
 */
inline void rtos_gpio_port_out(rtos_gpio_t *ctx, rtos_gpio_port_id_t port_id,
                               uint32_t value) {
 ...
 * \param app_data A pointer to application specific data to pass to the
 * application callback function \p cb.
 */
inline void rtos_gpio_isr_callback_set(rtos_gpio_t *ctx,
                                       rtos_gpio_port_id_t port_id,
                                       rtos_gpio_isr_cb_t cb, void *app_data) {
 ...
 */
inline void rtos_gpio_interrupt_enable(rtos_gpio_t *ctx,
                                       rtos_gpio_port_id_t port_id) {
 ...
 */
inline void rtos_gpio_interrupt_disable(rtos_gpio_t *ctx,
                                        rtos_gpio_port_id_t port_id) {
...
/**
 * Starts an RTOS GPIO driver instance. This must only be called by the tile
 * that owns the driver instance. It may be called either before or after
 * starting the RTOS, but must be called before any of the core GPIO driver
 * functions are called with this instance.
 *
 * rtos_gpio_init() must be called on this GPIO driver instance prior to calling
 * this.
 *
 ...
 * calling rtos_gpio_start() or any of the core GPIO driver functions with this
 * instance.
 *
