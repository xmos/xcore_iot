...
set(RTOS_CLOCK_CONTROL_DRIVER_DIR "${DRIVERS_DIR}/clock_control")
...
option(USE_RTOS_CLOCK_CONTROL_DRIVER "Enable to include RTOS Clock Control driver" TRUE)
...
#********************************
# Gather clock control sources
#********************************
set(THIS_LIB RTOS_CLOCK_CONTROL_DRIVER)
if(${USE_${THIS_LIB}})
    set(${THIS_LIB}_FLAGS "-Os")
...
set(DRIVERS_RTOS_SOURCES
    ...
    ${RTOS_CLOCK_CONTROL_DRIVER_SOURCES}
)
...
set(DRIVERS_RTOS_INCLUDES
    ...
    ${RTOS_CLOCK_CONTROL_DRIVER_INCLUDES}
    ${DRIVERS_DIR}
)
