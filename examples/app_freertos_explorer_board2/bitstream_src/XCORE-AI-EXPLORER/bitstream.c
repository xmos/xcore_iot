        ...
        chanend xTile3Chan)
{
    ...
    qspi_flash_dev_ch[SOC_PERIPHERAL_FROM_DMA_CH] = soc_channel_establish(xTile1Chan, soc_channel_inout);
    qspi_flash_dev_ch[SOC_PERIPHERAL_TO_DMA_CH] = soc_channel_establish(xTile1Chan, soc_channel_inout);
    qspi_flash_dev_ch[SOC_PERIPHERAL_CONTROL_CH] = soc_channel_establish(xTile1Chan, soc_channel_inout);
    qspi_flash_dev_ch[SOC_PERIPHERAL_IRQ_CH] = 0;
    ...
    tile0_device_instantiate(i2c_dev_ch, spi_master_dev_ch, qspi_flash_dev_ch, t0_gpio_dev_ch);
}
        ...
        chanend xTile3Chan)
{
    ...
    qspi_flash_dev_ch[SOC_PERIPHERAL_FROM_DMA_CH] = soc_channel_establish(xTile0Chan, soc_channel_inout);
    qspi_flash_dev_ch[SOC_PERIPHERAL_TO_DMA_CH] = soc_channel_establish(xTile0Chan, soc_channel_inout);
    qspi_flash_dev_ch[SOC_PERIPHERAL_CONTROL_CH] = soc_channel_establish(xTile0Chan, soc_channel_inout);
    qspi_flash_dev_ch[SOC_PERIPHERAL_IRQ_CH] = 0;
    ...
    tile1_device_instantiate(i2c_dev_ch, spi_master_dev_ch, qspi_flash_dev_ch, t0_gpio_dev_ch);
}
