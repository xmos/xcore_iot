...
#define DAC3101_PROC_BLK	  0x3C // Register 60 - DAC Processing Block Selection
...
#define DAC3101_REGREAD(reg, data)  {data = i2c_driver_read_reg(i2c_dev, DAC3101_I2C_DEVICE_ADDR, reg, &i2c_res); debug_printf("read reg:%x\n", data);}
#define DAC3101_REGWRITE(reg, val) {i2c_regop_res_t ret = i2c_driver_write_reg(i2c_dev, DAC3101_I2C_DEVICE_ADDR, reg, val); if(ret != I2C_REGOP_SUCCESS) debug_printf("DAC I2C NACK..\n");}
